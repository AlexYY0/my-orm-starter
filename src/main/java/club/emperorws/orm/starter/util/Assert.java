...
import club.emperorws.orm.util.*;
...
/**
 * 一些断言判断（copy from hutool）
 *
 * @author: EmperorWS
 * @date: 2023/5/16 10:48
 * @description: Assert: 一些断言判断
 */
public class Assert {
    ...
    public static void isTrue(boolean expression, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        isTrue(expression, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static void isFalse(boolean expression, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        isFalse(expression, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static void isNull(Object object, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        isNull(object, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static <T> T notNull(T object, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notNull(object, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static <T extends CharSequence> T notEmpty(T text, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notEmpty(text, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static <T extends CharSequence, X extends Throwable> T isEmpty(T text, Supplier<X> errorSupplier) throws X {
    ...
    public static <T extends CharSequence> T isEmpty(T text, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return isEmpty(text, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }

    public static <T extends CharSequence> T isEmpty(T text) throws IllegalArgumentException {
        return isEmpty(text, "[Assertion failed] - this String argument must no length; it must be null or empty");
    }
    ...
    public static <T extends CharSequence> T notBlank(T text, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notBlank(text, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static String notContain(String textToSearch, String substring, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notContain(textToSearch, substring, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static <T> T[] notEmpty(T[] array, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notEmpty(array, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static <T> T[] noNullElements(T[] array, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return noNullElements(array, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static <E, T extends Iterable<E>> T notEmpty(T collection, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notEmpty(collection, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
     ...
     * @see cn.hutool.core.map.MapUtil#isNotEmpty(Map)
     * @since 5.4.5
     */
    ...
    public static <K, V, T extends Map<K, V>> T notEmpty(T map, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return notEmpty(map, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static <K, V, T extends Map<K, V>, X extends Throwable> T isEmpty(T map, Supplier<X> errorSupplier) throws X {
    ...
    public static <K, V, T extends Map<K, V>> T isEmpty(T map, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        return isEmpty(map, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }

    public static <K, V, T extends Map<K, V>> T isEmpty(T map) throws IllegalArgumentException {
        return isEmpty(map, "[Assertion failed] - this map must be empty; it must contain no entry");
    }
    ...
    public static <T> T isInstanceOf(Class<?> type, T obj, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        ...
        if (false == type.isInstance(obj)) {
            throw new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params));
        }
        return obj;
    }
    ...
    public static void state(boolean expression, String errorMsgTemplate, Object... params) throws IllegalStateException {
        if (false == expression) {
            throw new IllegalStateException(MessageFormat.format(errorMsgTemplate, params));
        }
    }
    ...
    public static int checkBetween(int value, int min, int max, String errorMsgTemplate, Object... params) {
        return checkBetween(value, min, max, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static Number checkBetween(Number value, Number min, Number max) {
        ...
        if (valueDouble < minDouble || valueDouble > maxDouble) {
            throw new IllegalArgumentException(MessageFormat.format(TEMPLATE_VALUE_MUST_BE_BETWEEN_AND, min, max));
        }
        return value;
    }
    ...
    public static void notEquals(Object obj1, Object obj2, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        notEquals(obj1, obj2, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    public static void equals(Object obj1, Object obj2, String errorMsgTemplate, Object... params) throws IllegalArgumentException {
        equals(obj1, obj2, () -> new IllegalArgumentException(MessageFormat.format(errorMsgTemplate, params)));
    }
    ...
    private static String badIndexMsg(int index, int size, String desc, Object... params) {
        if (index < 0) {
            return MessageFormat.format("{} ({}) must not be negative", MessageFormat.format(desc, params), index);
        } else if (size < 0) {
            throw new IllegalArgumentException("negative size: " + size);
        } else { // index >= size
            return MessageFormat.format("{} ({}) must be less than size ({})", MessageFormat.format(desc, params), index, size);
        }
    }
    // -------------------------------------------------------------------------------------------------------------------------------------------- Private method end
}
